...
const Hero = () => {
  ...
  return (
    ...
    >
      <div data-aos='fade-right' className="relative xl:w-3/5 flex flex-col justify-center items-start w-full max-xl:padding-x">
        ...
        <p className="mb-12">
          Passionate aspiring software developer, eager to master coding and
      ...
      <div data-aos='flip-right ' className="hidden relative flex-1 lg:flex justify-center items-center">
        <img
          src={profilePic}
          alt="profile"
          width={397}
